...
| `GET` | `/:merchantId/orders/:orderId/kitchen-ticket` | Kitchen ticket JSON for printing |
...
| `/md/:hashId/kitchen-ticket/:orderId` | `KitchenTicketPrint` | Kitchen ticket print view (`?print=1` opens print dialog) |
